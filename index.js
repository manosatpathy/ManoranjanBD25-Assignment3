...
app.get("/hotels/sort/pricing", (req, res) => {
  ...
  hotelsCopy.sort((hotel1, hotel2) => sortByPricing(hotel1, hotel2, pricing));
  res.json({ hotels: hotelsCopy });
});

// Endpoint 2
function sortByRatings(hotel1, hotel2, rating) {
...
app.get("/hotels/sort/rating", (req, res) => {
  ...
  const hotelsCopy = hotels.slice();
  hotelsCopy.sort((hotel1, hotel2) => sortByRatings(hotel1, hotel2, rating));
  res.json({ hotels: hotelsCopy });
});
...
app.get("/hotels/sort/reviews", (req, res) => {
  ...
  const hotelsCopy = hotels.slice();
  hotelsCopy.sort((hotel1, hotel2) => sortByReviews(hotel1, hotel2, reviews));
  res.json({ hotels: hotelsCopy });
});
